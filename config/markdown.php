...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Markdown supports a variety of popular markdown parsers as drivers for
    ...
    */
    ...
    'default' => env('MARKDOWN_PARSER', 'null'),
    ...
    |--------------------------------------------------------------------------
    |
    | This option specifies if you want Markdown to extend the blade template
    | engine with a markdown specific "curly" braces '{%' & '%}', also with
    | a markdown specific directives such as '@markdown('expression')',
    | @markdown expression @endmarkdown and an alias '@markdown()'.
    |
    | Default: true
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This option specifies if you want Markdown to intergrate markdown views
