...
use ChristianKuri\Markdown\Parsers\NullParser;
use ChristianKuri\Markdown\Parsers\MarkdownParser;
use ChristianKuri\Markdown\Parsers\ParsedownParser;
use ChristianKuri\Markdown\Parsers\CommonMarkParser;
...
class ParserManager extends Manager
{
     ...
     *
     * @return \ChristianKuri\Markdown\Parsers\ParsedownParser
     */
     ...
     *
     * @return \ChristianKuri\Markdown\Parsers\MarkdownParser
     */
     ...
     *
     * @return \ChristianKuri\Markdown\Parsers\CommonMarkParser
     */
     ...
     *
     * @return \ChristianKuri\Markdown\Parsers\NullParser
     */
    ...
    {
        $default = $this->app['config']['markdown.default'];
    ...
    {
        return $this->app['config']["markdown.parsers.{$name}"];
    }
